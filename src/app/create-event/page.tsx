...
export default function CreateEventPage() {
  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-[#140b2d] via-[#1f1147] to-[#2a145c] text-white px-10 py-8">
      <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-orange-500/20 blur-[150px] rounded-full" />
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="mt-20 text-center">
          ...
          <h1 className="text-5xl font-bold mb-4">Make Your Event</h1>
          <p className="text-zinc-300 text-xl mb-8 max-w-xl mx-auto">
            Host your own pop-up, workshop, or meetup in minutes. Coming soon!
          </p>
          <div className="inline-block bg-orange-500/20 border border-orange-500/30 rounded-2xl px-8 py-4 text-orange-300">
            🚧 Feature in progress
          </div>
        </div>
      </div>
