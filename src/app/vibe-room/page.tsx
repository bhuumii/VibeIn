    ...
    <main className="relative min-h-screen bg-gradient-to-br from-[#140b2d] via-[#1f1147] to-[#2a145c] text-white px-10 py-8">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="mt-20 text-center">
          ...
          <h1 className="text-5xl font-bold mb-4">Vibe with Strangers</h1>
          <p className="text-zinc-300 text-xl mb-8 max-w-xl mx-auto">
            Join live rooms and connect with people going to the same events. Coming soon!
          </p>
          <div className="inline-block bg-blue-500/20 border border-blue-500/30 rounded-2xl px-8 py-4 text-blue-300">
            🚧 Feature in progress
          </div>
        </div>
      </div>
